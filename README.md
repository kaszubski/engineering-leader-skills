...
> **`v0.2.1`, small and opinionated by design.** The triggers and rubrics sharpen as they meet real PRs and real teams; that iteration is the point, not a caveat. Issues welcome, especially where a skill misfired.
